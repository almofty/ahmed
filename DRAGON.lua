...
if res ~= 200 then
print('\27[0;31m•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ايفيل'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "CH_EVIL")
...
send(msg.chat_id_, msg.id_,' ✿ تم تحديث السورس \n ✿ لديك اخر اصدار لسورس ايفيل\n ✿ الاصدار ↝ { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✿ اصدار سورس ايفيل \n ✿ الاصدار ↝{ v 1.5}')
end
if text == 'هيكتور  مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/CH_EVIL"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(username or 'CH_EVIL')..')'
status  = '\n ✿ تم ترقيته مطور'
...
usertext = '\n ✿ العضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVIL')..')'
status  = '\n ✿ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ العضو ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_EVIL')..') \n ✿ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✿ العضو : {["..data.first_name_.."](T.ME/CH_EVIL)}\n ✿ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✿ عذرا ↝ {["..data.first_name_.."](T.ME/CH_EVIL)}\n ✿ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
[ѕᴏᴜʀᴄᴇ ᴇᴠɪʟ ](t.me/CH_EVIL)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '℘𝗛𝙀𝗖𝙏𝙊𝙍℘',url="t.me/Uu_krl"}}, 
{{text = '℘𝙀𝗟𝗠𝙊𝗙𝙏𝙔℘',url="t.me/s5sss1"}}, 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝗩𝙄𝗟', url="t.me/CH_EVIL"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/CH_EVIL&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐄𝐕𝐈𝐋 ✿
✿اهلا بك في سورس ايفيل الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ✿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'H è Ꮯ Т ❍ R ',url="t.me/Uu_krl"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/CH_EVIL"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_EVIL')..') \n ✿ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CH_EVIL')..') \n ✿ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ✿ اهلا بك في متجر ملفات ايفيل\n ✿ ملفات السورس ↓\n•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n\n"
local TextE = "\n•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n ✿ علامة تعني { ✔️ } ملف مفعل\n ✿ علامة تعني { ✖ } ملف معطل\n ✿ قناة سورس ايفيل ↓\n".." ✿ [اضغط هنا لدخول](t.me/CH_EVIL) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✿ عذرا الملف لايدعم سورس ايفيل \n") 
end
return false
end
...
if text == ("مسح قائمه ايفيل") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✿ تم مسح قائمه ايفيل')
return false
end

if text == 'قائمه ايفيل' and Sudo(msg) then
...
if text == ("رفع ايفيل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايفيل @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ايفيل @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايفيل (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ايفيل (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ايفيل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايفيل @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ايفيل @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايفيل (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ايفيل (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✿ لعضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVIL')..')'
status  = '\n ✿ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✿ العضو ↝ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✿ العضــو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVIL')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(text1[3] or 'CH_EVIL')..')'..'\n ✿ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفيل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ايفيل')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."CH_EVIL:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."CH_EVIL:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CH_EVIL:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CH_EVIL:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✿تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CH_EVIL:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CH_EVIL:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ايفيل يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفيل').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVIL')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑖𝑣𝑒𝑙', url="t.me/CH_EVIL"},
...
send(msg.chat_id_, msg.id_, t..'•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴٴ\n✿ [ ѕᴏụʀᴄᴇ ᴇɪᴠᴇʟ ](t.me/CH_EVIL)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ايفيل')
